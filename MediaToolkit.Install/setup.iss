...
Source: "{#CurrentSourcePath}\MediaToolkit.SharedTypes.dll"; DestDir: "{app}"; Flags: replacesameversion
Source: "{#CurrentSourcePath}\MediaToolkit.SharedTypes.pdb"; DestDir: "{app}"; Flags: replacesameversion
