...
namespace MediaToolkit.Nvidia
{
    ...
    */
    ...
    /// ::NV_ENC_ERR_INVALID_PARAM
    /// ::NV_ENC_ERR_GENERIC</returns>
    public unsafe delegate NvEncStatus GetEncodeProfileGuidsFn(NvEncoderPtr encoder, Guid encodeGuid, Guid* profileGuids, uint guidArraySize, ref uint guidCount);
    ...
    /// ::NV_ENC_ERR_INVALID_PARAM
    /// ::NV_ENC_ERR_GENERIC</returns>
    public unsafe delegate NvEncStatus GetEncodeGuidsFn(NvEncoderPtr encoder, Guid* guids, uint guidArraySize, ref uint guidCount);
    ...
    /// ::NV_ENC_ERR_INVALID_PARAM
    /// ::NV_ENC_ERR_GENERIC</returns>
    public unsafe delegate NvEncStatus GetInputFormatsFn(NvEncoderPtr encoder, Guid encodeGuid, NvEncBufferFormat* inputFmts, uint inputFmtArraySize, ref uint inputFmtCount);
    ...
    /// ::NV_ENC_ERR_INVALID_PARAM
    /// ::NV_ENC_ERR_GENERIC</returns>
    public unsafe delegate NvEncStatus GetEncodePresetGuidsFn(NvEncoderPtr encoder, Guid encodeGuid, Guid* presetGuids, uint guidArraySize, ref uint encodePresetGuidCount);
